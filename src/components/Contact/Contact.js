    ...
    <div>
      <div className="con-full">
        <div className="contact container">
          ...
          <div className="con-text">List Your Show</div>
          <div className="con-con">
            <div className="con-con-text">
              Got a show, event, activity or a great experience? Partner with us
              & get listed on BookMyShow
            </div>
            <div className="con-con-button">Contact today!</div>
          </div>
        </div>
      </div>
      <div className="customer-serv">
        <div className="cust-img container">
          <div className="cust-img-1">
            <div className="cust-img-img">
              <svg
            ...
            <div className="cust-img-con">24/7 CUSTOMER CARE</div>
          </div>
          <div className="cust-img-1">
            <div className="cust-img-img">
              <svg
            ...
            <div className="cust-img-con">RECENT BOOKING CONFIRMATION</div>
          </div>
          <div className="cust-img-1">
            <div className="cust-img-img">
              <svg
            ...
            <div className="cust-img-con">SUBSCRIBE TO THE NEWSLETTER</div>
          </div>
        </div>
      </div>
    </div>
